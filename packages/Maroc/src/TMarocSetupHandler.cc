...
TMarocSetupHandler::TMarocSetupHandler():
TRealSetupHandler()
{
...
void TMarocSetupHandler::fillMaps(){
...
void TMarocSetupHandler::processLine(string line){


}


int TMarocSetupHandler::getMarocCard(int globalId){
	int MarocCard;
...
int TMarocSetupHandler::getMarocChannelFromGlobal(int globalId){
	int MarocChannel;
...
int TMarocSetupHandler::getMarocChannelFromH8500(int H8500Id){
	int MarocChannel=-1;
...
int TMarocSetupHandler::getH8500IdFromMaroc(int marocChannel){
	int H8500Id=-1;
	map<int,int>::iterator it;
...
int TMarocSetupHandler::getH8500IdFromGlobal(int globalId){
	int H8500Id;
	int MarocChannel;
...
int  TMarocSetupHandler::getPixelReconId(int globalID){
...
int TMarocSetupHandler::getPixelReconId(int iRealDet,int iRealPixel){
...
double TMarocSetupHandler::getPixelGainFromGlobal(int globalID,int igain){
    int MarocCard=this->getMarocCard(globalID);           /*The CARD id: 0 ... 63. */ /*This is the number to identify the "REAL" detector*/
    int H8500Id=this->getH8500IdFromGlobal(globalID);     /*The H8500 pixel id*/
