  ...
  */
  void TOpNoviceDetectorLight::init(){
    ...
    */
    ...
    double TOpNoviceDetectorLight::getDetQE(int iface,int idetector){
      double ret=0;
      if (this->isDetPresent(iface,idetector)==0) ret=0;
      else ret=detQE[iface][idetector];
      return ret;
    }
    
    void TOpNoviceDetectorLight::setDetQE(int iface,int idetector,double QE){
      detQE[iface][idetector]=QE;
    }
