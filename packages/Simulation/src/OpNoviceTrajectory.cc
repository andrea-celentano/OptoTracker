...
// ********************************************************************
//
// $Id: OpNoviceTrajectory.cc 72349 2013-07-16 12:13:16Z gcosmo $
//
/// \file optical/OpNovice/src/OpNoviceTrajectory.cc
/// \brief Implementation of the OpNoviceTrajectory class
//
//
...
G4ThreadLocal G4Allocator<OpNoviceTrajectory>* OpNoviceTrajectoryAllocator = 0;
...
OpNoviceTrajectory::OpNoviceTrajectory(const G4Track* aTrack)
...
OpNoviceTrajectory::OpNoviceTrajectory(OpNoviceTrajectory &right)
...
void OpNoviceTrajectory::DrawTrajectory() const
{
  ...
  //type and to selectively eliminate drawing of certain trajectories.
	...
	if(!fForceDraw && (!fDrawit || fForceNoDraw)) {
		...
		//	G4cout<<fForceDraw<<" "<<fDrawit<<" "<<fForceNoDraw<<G4endl;		
		return;
	}
