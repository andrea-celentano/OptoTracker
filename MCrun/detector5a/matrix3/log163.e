...
Warning in <TFile::Init>: file root/run_163_0.root probably not closed, trying to recover
Info in <TFile::Recover>: root/run_163_0.root, recovered key TTree:Event at address 1283990371
Warning in <TFile::Init>: successfully recovered 1 keys
Error in <TAnalysis::configure>: No detector found in any file, and no txt file passed with -det option
mv: cannot stat `voxel_163.dat': No such file or directory
