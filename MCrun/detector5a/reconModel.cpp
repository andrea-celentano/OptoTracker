...
void writeMatrix4(TDetector *det,string fname){
  int ipixel,iface;
  int ivoxel;
  double val=0;
  double tmp;
...
int macro(){
  ...
  cout<<" "<<endl;
  getPixelCenter(0,4).Print();
  det->getPosPixel(0,0,4).Print();

  cout<<" "<<endl;
  getPixelCenter(0,8).Print();
  det->getPosPixel(0,1,0).Print();

  cout<<" "<<endl;
  getPixelCenter(0,128).Print();
  det->getPosPixel(0,2,0).Print();

  cout<<" "<<endl;
  getPixelCenter(0,129).Print();
  det->getPosPixel(0,2,1).Print();
