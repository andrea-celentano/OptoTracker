...
setenv OPTOAPPS /project/Gruppo3/fiber6/apps
setenv GEANT4_VERSION       4.10.01
setenv G4SYSTEM             Linux-g++
setenv G4ROOT               ${OPTOAPPS}/geant4/4.10.01/SL5/no_multithread
setenv G4INSTALL            ${OPTOAPPS}/geant4/4.10.01/SL5/no_multithread
...
setenv G4DATA		    ${OPTOAPPS}/geant4/4.10.01/data
...
#setenv CLHEP_BASE_DIR       ${OPTOAPPS}/clhep/$OS_NAME
