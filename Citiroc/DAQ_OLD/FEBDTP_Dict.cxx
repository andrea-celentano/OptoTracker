...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::FEBDTP*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("FEBDTP", ::FEBDTP::Class_Version(), "FEBDTP.hxx", 77,
   ...
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const ::FEBDTP*)0x0); R__UseDummy(_R__UNIQUE_(Init));
...
TClass *FEBDTP::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::FEBDTP*)0x0)->GetClass(); }
   return fgIsA;
}
...
"/local/root6/include",
"/work/OptoTracker/Citiroc/FEBDAQMULT/DAQ/",
0
    };
...
class __attribute__((annotate(R"ATTRDUMP(FEBDTP)ATTRDUMP"))) __attribute__((annotate(R"ATTRDUMP(FEBDTP)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$FEBDTP.hxx")))  FEBDTP;
)DICTFWDDCLS";
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("FEBDTP_Dict",
        ...
        TriggerDictionaryInitialization_FEBDTP_Dict_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
