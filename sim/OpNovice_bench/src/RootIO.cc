...
void RootIO::Init(int n){
	...
	fHistograms1D->push_back(new TH1D("hy","hy",200,-3.1,3.1));
	fHistograms1D->push_back(new TH1D("hY1","hY1",200,-3.1,3.1));
	
	
	fHistograms2D->push_back(new TH2D("hyx","hyx",600,-3.1,3.1,600,-3.1,3.1));
	fHistograms2D->push_back(new TH2D("hyz","hyz",600,-3.1,3.1,600,-3.1,3.1));
	fHistograms2D->push_back(new TH2D("h2","h2",200,-3.1,3.1,200,-3.1,3.1));
