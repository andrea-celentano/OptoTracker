...
doPixels(string fname,int iv=-1){
	...
	// TH2D *h5=new TH2D("h5","h5;+x;y",Npx,-Lx/2,Lx/2.,Npy,-Ly/2.,Ly/2.);
	// TH2D *h6=new TH2D("h6","h6;+x;y",Npx,-Lx/2,Lx/2.,Npy,-Ly/2.,Ly/2.);
	...
	c->cd(9);h1->ProjectionX()->Draw();
	c->cd(10);h2->ProjectionX()->Draw();
	c->cd(11);h3->ProjectionX()->Draw();
	c->cd(12);h4->ProjectionX()->Draw();
	
	TCanvas *c1=new TCanvas("c1","c1");
	c1->Divide(4,3);
	c1->cd(5);h1t->Draw("colz");
	c1->cd(6);h2t->Draw("colz");
	c1->cd(7);h3t->Draw("colz");
	c1->cd(8);h4t->Draw("colz");
