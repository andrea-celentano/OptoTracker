...
// ********************************************************************
//
// $Id: OpNoviceUserTrackInformation.hh 68752 2013-04-05 10:23:47Z gcosmo $
//
/// \file optical/OpNovice/include/OpNoviceUserTrackInformation.hh
/// \brief Definition of the OpNoviceUserTrackInformation class
//
#include "G4VUserTrackInformation.hh"
#include "globals.hh"

#ifndef OpNoviceUserTrackInformation_h
#define OpNoviceUserTrackInformation_h 1

enum OpNoviceTrackStatus { active=1, hitPMT=2, absorbed=4, boundaryAbsorbed=8,inactive=14};
...
class OpNoviceUserTrackInformation : public G4VUserTrackInformation
{
  public:

    OpNoviceUserTrackInformation();
    virtual ~OpNoviceUserTrackInformation();
    ...
    void IncRefractions(){fRefractions++;}
    G4int GetRefractionCount()const {return fRefractions;}
