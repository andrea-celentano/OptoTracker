...
//The experimental hall walls are all 100cm away from housing walls
	...
	G4Box* Scintillator_box_Y0 = new G4Box("Scintillator_Y0",fScint_x/2,deltaScint/2,fScint_z/2);
	G4Box* Scintillator_box_Y1 = new G4Box("Scintillator_Y1",fH8500box_x/2,deltaScint,fH8500box_y/2);
	G4SubtractionSolid *Scintillator_box_Y = new G4SubtractionSolid("Scintillator_Y",Scintillator_box_Y0,Scintillator_box_Y1);
	
	G4LogicalVolume* Scintillator_log_Y = new G4LogicalVolume(Scintillator_box_Y0,fAir,"Scintillator_Y",0,0,0);
	...
	//G4LogicalVolume* Scintillator_log_Y = new G4LogicalVolume(Scintillator_box_X,fAir,"Scintillator_Y",0,0,0);
	G4LogicalVolume* Scintillator_log_Y1 = new G4LogicalVolume(Scintillator_box_Y,fAir,"Scintillator_Y",0,0,0);
	G4VPhysicalVolume* Scintillator_phys_Ybot = new G4PVPlacement(0,G4ThreeVector(0.,-(fScint_y+deltaScint)/2,0.),Scintillator_log_Y1,"Scintillator_Yb",fExperimentalHall_log,false,1);
	...
	G4RotationMatrix* yRot_5=new G4RotationMatrix;
	yRot_5->rotateX(M_PI/2.*rad);	
	G4VPhysicalVolume* h8500_phys5 = new G4PVPlacement(yRot_5,G4ThreeVector(0*cm,-(fScint_y+fH8500box_z)/2.,0.*cm),h8500,"PMT5",fExperimentalHall_log,false,5);
	...
	G4double ScintSurfReflectivity[numScintSurf]={0.02,0.02};
