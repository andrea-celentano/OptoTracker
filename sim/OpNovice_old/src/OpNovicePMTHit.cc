...
// ********************************************************************
//
// $Id: OpNovicePMTHit.cc 72250 2013-07-12 08:59:26Z gcosmo $
//
/// \file optical/OpNovice/src/OpNovicePMTHit.cc
/// \brief Implementation of the OpNovicePMTHit class
//
//
...
//ClassImp(OpNovicePMTHit)
G4ThreadLocal G4Allocator<OpNovicePMTHit>* OpNovicePMTHitAllocator=0;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

OpNovicePMTHit::OpNovicePMTHit()
: fPmtNumber(-1),fPhotons(0),fPhysVol(0),fPhysVolMother(0),fDrawit(false),fFirstTime(1000000.),fName("")
//,TObject()
{}
...
OpNovicePMTHit::OpNovicePMTHit(const OpNovicePMTHit &right) : G4VHit()//,TObject()
{
	...
	fX.clear();
	fY.clear();
	for (int ii=0;ii<right.fPhotons;ii++){
...
const OpNovicePMTHit& OpNovicePMTHit::operator=(const OpNovicePMTHit &right){
	fPmtNumber=right.fPmtNumber;
	fPhotons=right.fPhotons;
	fPhysVol=right.fPhysVol;
	fPhysVolMother=right.fPhysVolMother;
...
G4int OpNovicePMTHit::operator==(const OpNovicePMTHit &right) const{
	return false;
