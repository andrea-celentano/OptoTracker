// Generated at Wed Nov 16 23:37:11 2016. Do not modify it
...
#endif
#include "/work/OptoTracker/software/packages/Maroc/include/MarocClasses.hh"
#ifdef CONST
# undef CONST
#endif
...
namespace {
  ...
  ::Reflex::Type type_1630 = ::Reflex::TypeBuilder(Reflex::Literal("char"));
  ...
  ::Reflex::Type type_2212 = ::Reflex::TypeBuilder(Reflex::Literal("TMarocHit"));
  ...
  ::Reflex::Type type_1770 = ::Reflex::TypeBuilder(Reflex::Literal("TMarocEventHeader"));
  ...
  ::Reflex::Type type_9119 = ::Reflex::ReferenceBuilder(type_1244);
  ::Reflex::Type type_1244c = ::Reflex::ConstBuilder(type_1244);
  ::Reflex::Type type_9120 = ::Reflex::ReferenceBuilder(type_1244c);
  ...
  ::Reflex::Type type_2795 = ::Reflex::PointerBuilder(type_1630c);
  ::Reflex::Type type_1693 = ::Reflex::TypedefTypeBuilder(Reflex::Literal("Version_t"), type_284);
  ::Reflex::Type type_8926 = ::Reflex::ReferenceBuilder(type_115);
  ::Reflex::Type type_4280 = ::Reflex::ReferenceBuilder(type_1290);
  ::Reflex::Type type_9183 = ::Reflex::ReferenceBuilder(type_1770);
  ::Reflex::Type type_1770c = ::Reflex::ConstBuilder(type_1770);
  ::Reflex::Type type_9184 = ::Reflex::ReferenceBuilder(type_1770c);
  ::Reflex::Type type_9266 = ::Reflex::ReferenceBuilder(type_2212);
  ::Reflex::Type type_2212c = ::Reflex::ConstBuilder(type_2212);
  ::Reflex::Type type_9267 = ::Reflex::ReferenceBuilder(type_2212c);
} // unnamed namespace
...
static  void operator_3922( void* retaddr, void* o, const std::vector<void*>& arg, void*)
{
...
static void constructor_3926( void* retaddr, void* mem, const std::vector<void*>&, void*) {
...
static void destructor_3928(void*, void * o, const std::vector<void*>&, void *) {
...
static  void method_3936( void* retaddr, void* o, const std::vector<void*>& arg, void*)
{
  if ( arg.size() == 1 ) {
...
static  void method_3939( void* retaddr, void* o, const std::vector<void*>&, void*)
{
  if (retaddr) new (retaddr) (Version_t)((((::TMarocSetupHandler*)o)->Class_Version)());
  else   (((::TMarocSetupHandler*)o)->Class_Version)();
}

static  void method_3940( void*, void* o, const std::vector<void*>&, void*)
{
...
static  void method_3944( void*, void* o, const std::vector<void*>& arg, void*)
{
...
void __TMarocSetupHandler_dict() {
  ...
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_9119, type_9120), Reflex::Literal("operator="), operator_3922, 0, "", ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL | ::Reflex::OPERATOR)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void, type_9120), Reflex::Literal("TMarocSetupHandler"), constructor_3923, 0, "", ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL | ::Reflex::CONSTRUCTOR)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void), Reflex::Literal("TMarocSetupHandler"), constructor_3926, 0, 0, ::Reflex::PUBLIC | ::Reflex::EXPLICIT | ::Reflex::CONSTRUCTOR)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void, type_2392), Reflex::Literal("TMarocSetupHandler"), constructor_3927, 0, "fname", ::Reflex::PUBLIC | ::Reflex::CONSTRUCTOR)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void), Reflex::Literal("~TMarocSetupHandler"), destructor_3928, 0, 0, ::Reflex::PUBLIC | ::Reflex::VIRTUAL | ::Reflex::DESTRUCTOR )
...
void __TMarocSetupHandler_db_datamem(Reflex::Class* cl) {
  ...
  .AddDataMember(type_2558, Reflex::Literal("m_MarocToH8500"), OffsetOf(__shadow__::__TMarocSetupHandler, m_MarocToH8500), ::Reflex::PRIVATE)
  .AddDataMember(type_2558, Reflex::Literal("m_H8500ToMaroc"), OffsetOf(__shadow__::__TMarocSetupHandler, m_H8500ToMaroc), ::Reflex::PRIVATE);
}
//------Delayed function member builder for class TMarocSetupHandler -------------------
void __TMarocSetupHandler_db_funcmem(Reflex::Class* cl) {
  ::Reflex::ClassBuilder(cl)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_47, type_47), Reflex::Literal("getMarocCard"), method_3929, 0, "globalID", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_47, type_47), Reflex::Literal("getMarocChannelFromGlobal"), method_3930, 0, "globalID", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_47, type_47), Reflex::Literal("getMarocChannelFromH8500"), method_3931, 0, "H8500ID", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_47, type_47), Reflex::Literal("getH8500IdFromGlobal"), method_3932, 0, "globalID", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_47, type_47), Reflex::Literal("getH8500IdFromMaroc"), method_3933, 0, "globalID", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_47, type_47), Reflex::Literal("getPixelReconId"), method_3934, 0, "globalID", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_47, type_47, type_47), Reflex::Literal("getPixelReconId"), method_3935, 0, "iRealDet;iRealPixel", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_362, type_47, type_47), Reflex::Literal("getPixelGainFromGlobal"), method_3936, 0, "globalID;igain=0", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_821), Reflex::Literal("Class"), method_3937, 0, 0, ::Reflex::PUBLIC | ::Reflex::STATIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2795), Reflex::Literal("Class_Name"), method_3938, 0, 0, ::Reflex::PUBLIC | ::Reflex::STATIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_1693), Reflex::Literal("Class_Version"), method_3939, 0, 0, ::Reflex::PUBLIC | ::Reflex::STATIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_177), Reflex::Literal("Dictionary"), method_3940, 0, 0, ::Reflex::PUBLIC | ::Reflex::STATIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_821), Reflex::Literal("IsA"), method_3941, 0, 0, ::Reflex::PUBLIC | ::Reflex::VIRTUAL | ::Reflex::CONST)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_177, type_8926), Reflex::Literal("ShowMembers"), method_3942, 0, "", ::Reflex::PUBLIC | ::Reflex::VIRTUAL)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_177, type_4280), Reflex::Literal("Streamer"), method_3943, 0, "", ::Reflex::PUBLIC | ::Reflex::VIRTUAL)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_177, type_4280), Reflex::Literal("StreamerNVirtual"), method_3944, 0, "ClassDef_StreamerNVirtual_b", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2795), Reflex::Literal("DeclFileName"), method_3945, 0, 0, ::Reflex::PUBLIC | ::Reflex::STATIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_47), Reflex::Literal("ImplFileLine"), method_3946, 0, 0, ::Reflex::PUBLIC | ::Reflex::STATIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2795), Reflex::Literal("ImplFileName"), method_3947, 0, 0, ::Reflex::PUBLIC | ::Reflex::STATIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_47), Reflex::Literal("DeclFileLine"), method_3948, 0, 0, ::Reflex::PUBLIC | ::Reflex::STATIC);
}
...
static void constructor_4290( void* retaddr, void* mem, const std::vector<void*>& arg, void*) {
...
static void constructor_4291( void* retaddr, void* mem, const std::vector<void*>&, void*) {
  if (retaddr) *(void**)retaddr = ::new(mem) ::TMarocEventHeader();
  else ::new(mem) ::TMarocEventHeader();
}

static void destructor_4292(void*, void * o, const std::vector<void*>&, void *) {
...
static  void method_4298( void*, void* o, const std::vector<void*>&, void*)
{
...
static  void method_4306( void* retaddr, void* o, const std::vector<void*>&, void*)
{
  if (retaddr) new (retaddr) (int)((((::TMarocEventHeader*)o)->DeclFileLine)());
  else   (((::TMarocEventHeader*)o)->DeclFileLine)();
}

static void method_newdel_1770( void* retaddr, void*, const std::vector<void*>&, void*)
{
  static ::Reflex::NewDelFunctions s_funcs;
...
void __TMarocEventHeader_dict() {
  ...
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_9183, type_9184), Reflex::Literal("operator="), operator_4289, 0, "", ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL | ::Reflex::OPERATOR)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void, type_9184), Reflex::Literal("TMarocEventHeader"), constructor_4290, 0, "", ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL | ::Reflex::CONSTRUCTOR)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void), Reflex::Literal("TMarocEventHeader"), constructor_4291, 0, 0, ::Reflex::PUBLIC | ::Reflex::EXPLICIT | ::Reflex::CONSTRUCTOR)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void), Reflex::Literal("~TMarocEventHeader"), destructor_4292, 0, 0, ::Reflex::PUBLIC | ::Reflex::VIRTUAL | ::Reflex::DESTRUCTOR )
  .AddFunctionMember<void*(void)>(Reflex::Literal("__getNewDelFunctions"), method_newdel_1770, 0, 0, ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL)
...
void __TMarocEventHeader_db_funcmem(Reflex::Class* cl) {
  ::Reflex::ClassBuilder(cl)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_47), Reflex::Literal("getMultiplicity"), method_4293, 0, 0, ::Reflex::PUBLIC | ::Reflex::CONST)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_177, type_47), Reflex::Literal("setMultiplicity"), method_4294, 0, "multiplicity", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_821), Reflex::Literal("Class"), method_4295, 0, 0, ::Reflex::PUBLIC | ::Reflex::STATIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2795), Reflex::Literal("Class_Name"), method_4296, 0, 0, ::Reflex::PUBLIC | ::Reflex::STATIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_1693), Reflex::Literal("Class_Version"), method_4297, 0, 0, ::Reflex::PUBLIC | ::Reflex::STATIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_177), Reflex::Literal("Dictionary"), method_4298, 0, 0, ::Reflex::PUBLIC | ::Reflex::STATIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_821), Reflex::Literal("IsA"), method_4299, 0, 0, ::Reflex::PUBLIC | ::Reflex::VIRTUAL | ::Reflex::CONST)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_177, type_8926), Reflex::Literal("ShowMembers"), method_4300, 0, "", ::Reflex::PUBLIC | ::Reflex::VIRTUAL)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_177, type_4280), Reflex::Literal("Streamer"), method_4301, 0, "", ::Reflex::PUBLIC | ::Reflex::VIRTUAL)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_177, type_4280), Reflex::Literal("StreamerNVirtual"), method_4302, 0, "ClassDef_StreamerNVirtual_b", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2795), Reflex::Literal("DeclFileName"), method_4303, 0, 0, ::Reflex::PUBLIC | ::Reflex::STATIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_47), Reflex::Literal("ImplFileLine"), method_4304, 0, 0, ::Reflex::PUBLIC | ::Reflex::STATIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2795), Reflex::Literal("ImplFileName"), method_4305, 0, 0, ::Reflex::PUBLIC | ::Reflex::STATIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_47), Reflex::Literal("DeclFileLine"), method_4306, 0, 0, ::Reflex::PUBLIC | ::Reflex::STATIC);
}
//------Stub functions for class TMarocHit -------------------------------
static  void operator_4791( void* retaddr, void* o, const std::vector<void*>& arg, void*)
{
  if (retaddr) *(void**)retaddr = (void*)&(((::TMarocHit*)o)->operator=)(*(const ::TMarocHit*)arg[0]);
  else   (((::TMarocHit*)o)->operator=)(*(const ::TMarocHit*)arg[0]);
}

static void constructor_4792( void* retaddr, void* mem, const std::vector<void*>& arg, void*) {
  if (retaddr) *(void**)retaddr = ::new(mem) ::TMarocHit(*(const ::TMarocHit*)arg[0]);
  else ::new(mem) ::TMarocHit(*(const ::TMarocHit*)arg[0]);
}

static void constructor_4793( void* retaddr, void* mem, const std::vector<void*>&, void*) {
...
static  void method_4804( void*, void* o, const std::vector<void*>&, void*)
{
...
static void method_newdel_2212( void* retaddr, void*, const std::vector<void*>&, void*)
{
  static ::Reflex::NewDelFunctions s_funcs;
...
void __TMarocHit_dict() {
  ...
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_9266, type_9267), Reflex::Literal("operator="), operator_4791, 0, "", ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL | ::Reflex::OPERATOR)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void, type_9267), Reflex::Literal("TMarocHit"), constructor_4792, 0, "", ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL | ::Reflex::CONSTRUCTOR)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void), Reflex::Literal("TMarocHit"), constructor_4793, 0, 0, ::Reflex::PUBLIC | ::Reflex::EXPLICIT | ::Reflex::CONSTRUCTOR)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_void), Reflex::Literal("~TMarocHit"), destructor_4794, 0, 0, ::Reflex::PUBLIC | ::Reflex::VIRTUAL | ::Reflex::DESTRUCTOR )
  .AddFunctionMember<void*(void)>(Reflex::Literal("__getNewDelFunctions"), method_newdel_2212, 0, 0, ::Reflex::PUBLIC | ::Reflex::ARTIFICIAL)
...
void __TMarocHit_db_funcmem(Reflex::Class* cl) {
  ::Reflex::ClassBuilder(cl)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_47), Reflex::Literal("getCharge"), method_4795, 0, 0, ::Reflex::PUBLIC | ::Reflex::CONST)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_177, type_47), Reflex::Literal("setCharge"), method_4796, 0, "charge", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_953), Reflex::Literal("isHit"), method_4797, 0, 0, ::Reflex::PUBLIC | ::Reflex::CONST)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_177, type_953), Reflex::Literal("setHit"), method_4798, 0, "Hit", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_47), Reflex::Literal("getMarocId"), method_4799, 0, 0, ::Reflex::PUBLIC | ::Reflex::CONST)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_177, type_47), Reflex::Literal("setMarocId"), method_4800, 0, "marocId", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_821), Reflex::Literal("Class"), method_4801, 0, 0, ::Reflex::PUBLIC | ::Reflex::STATIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2795), Reflex::Literal("Class_Name"), method_4802, 0, 0, ::Reflex::PUBLIC | ::Reflex::STATIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_1693), Reflex::Literal("Class_Version"), method_4803, 0, 0, ::Reflex::PUBLIC | ::Reflex::STATIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_177), Reflex::Literal("Dictionary"), method_4804, 0, 0, ::Reflex::PUBLIC | ::Reflex::STATIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_821), Reflex::Literal("IsA"), method_4805, 0, 0, ::Reflex::PUBLIC | ::Reflex::VIRTUAL | ::Reflex::CONST)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_177, type_8926), Reflex::Literal("ShowMembers"), method_4806, 0, "", ::Reflex::PUBLIC | ::Reflex::VIRTUAL)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_177, type_4280), Reflex::Literal("Streamer"), method_4807, 0, "", ::Reflex::PUBLIC | ::Reflex::VIRTUAL)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_177, type_4280), Reflex::Literal("StreamerNVirtual"), method_4808, 0, "ClassDef_StreamerNVirtual_b", ::Reflex::PUBLIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2795), Reflex::Literal("DeclFileName"), method_4809, 0, 0, ::Reflex::PUBLIC | ::Reflex::STATIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_47), Reflex::Literal("ImplFileLine"), method_4810, 0, 0, ::Reflex::PUBLIC | ::Reflex::STATIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_2795), Reflex::Literal("ImplFileName"), method_4811, 0, 0, ::Reflex::PUBLIC | ::Reflex::STATIC)
  .AddFunctionMember(::Reflex::FunctionTypeBuilder(type_47), Reflex::Literal("DeclFileLine"), method_4812, 0, 0, ::Reflex::PUBLIC | ::Reflex::STATIC);
}
namespace {
  struct Dictionaries {
    Dictionaries() {
    ...
    ~Dictionaries() {
      ...
      type_1770.Unload(); // class TMarocEventHeader 
      type_2212.Unload(); // class TMarocHit 
    }
  };
